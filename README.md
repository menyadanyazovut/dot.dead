...
final commits, find the 13 monuments of the legends, and collect the papers
they carry.
...
- **E** — draw / pocket the compass; with a paper in your crosshair, **E** takes it
...
shores — the compass refuses to come out while you wade), and a flat
...
Thirteen legendary dead products (Flash, IE, Netscape, Google Reader, Google
Wave, GeoCities, Winamp, Vine, AIM, Napster, MySpace, Windows XP, Skype) have
...
(n/13) both show for 10 s and fade together. Progress resets on reload —
every visit is a fresh hunt.
...
paper is kilometers away; when all 13 are found it spins slowly, at peace.
